...
// Legislation data
const legislation: LegislationItem[] = [
  {
    id: 1,
    date: "22 Dec 2008",
    title: "The Regulations",
    category: "Legislation and Regulation",
    description: "Regulations accompanying the Intellectual Property Rights from Publicly Financed Research and Development Act, 2008.",
    downloadUrl: "https://www.nipmo.org/_files/ugd/fcb033_5db29cb9483c403583c8073d3b8b1124.pdf"
  },
  {
    id: 2,
    date: "22 Dec 2008",
    title: "IPR Act of 2008",
    category: "Legislation and Regulation",
    description: "The Intellectual Property Rights from Publicly Financed Research and Development Act (No. 51 of 2008) - the foundational legislation governing IP management in South Africa's publicly funded research ecosystem.",
    downloadUrl: "https://www.nipmo.org/_files/ugd/fcb033_dfd8218e31ea47bab9211383c562eeca.pdf"
  }
]
...
export default function Legislation() {
  ...
  // Filter legislation based on search query
  const filteredLegislation = useMemo(() => {
    if (!searchQuery.trim()) return legislation
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Legislation Content - Clean White Design */}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Search and browse through our comprehensive collection of legislation and regulatory documents.
              </p>
              ...
              <div className="relative max-w-md">
                ...
                <Input
                  type="text"
                  placeholder="Search legislation and regulations..."
                  value={searchQuery}
              ...
              <p className="mt-4 text-sm text-gray-500">
                {filteredLegislation.length} of {legislation.length} legislation documents found
              </p>
            </div>
            ...
            {filteredLegislation.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {filteredLegislation.map((item) => (
                  <Card key={item.id} className="bg-white border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-200 h-full flex flex-col overflow-hidden">
                    {/* Top Half - Image covering full width and height */}
                    <div className="relative h-48 w-full">
                      <img
                        src="https://ext.same-assets.com/4026891959/2504409759.png"
                        alt="Legislation Document"
                    ...
                    <CardContent className="p-4 flex flex-col flex-1">
                      ...
                      <p className="text-sm font-medium text-[#a4ba36] mb-2">{item.category}</p>
              ...
              <div className="text-center py-16">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No legislation documents found</h3>
